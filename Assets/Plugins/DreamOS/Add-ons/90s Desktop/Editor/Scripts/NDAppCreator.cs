...
{
    public class NDAppCreator : EditorWindow
    {
        static NDAppCreator window;
        ...
        [MenuItem("Tools/DreamOS/Add-ons/90s Desktop/App Creator", false, 0)]
        public static void ShowWindow()
        {
            window = GetWindow<NDAppCreator>("DreamOS - App Creator (90s)");
